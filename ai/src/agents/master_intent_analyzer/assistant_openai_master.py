    ...
    while True:
        ...
        for chunk in response:
            ...
            if chunk.choices[0].delta.content:
                yield {"state": state, "data": chunk.choices[0].delta.content , "data_type": "text", "responding_model": "master", "status": "ok"}   # your output method
        ...
        if tools_obj["tool_calls"]:
                ...
                try:
                    for tool_call in tools_obj["tool_calls"]:
                        # print(tool_call)
                        for data in  run_tool(tools_dict,tool_call['function']['name'],tool_call['function']['arguments']):
                            # print(word , end = '')
                            yield  data  # your output method
